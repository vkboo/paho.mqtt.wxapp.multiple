...
(function ExportLibrary(root, factory) {
  ...
  var PahoMQTT = (function (wx) {
    ...
    ClientImpl.prototype._doConnect = function (wsurl) {
      ...
      this.wsTask.onOpen(scope(this._on_socket_open, this));
      // wx.onSocketOpen(scope(this._on_socket_open, this))

      this.wsTask.onMessage(scope(this._on_socket_message, this));
      // wx.onSocketMessage(scope(this._on_socket_message, this))

      this.wsTask.onError(scope(this._on_socket_error, this));
      // wx.onSocketError(scope(this._on_socket_error, this))

      this.wsTask.onClose(scope(this._on_socket_close, this));
